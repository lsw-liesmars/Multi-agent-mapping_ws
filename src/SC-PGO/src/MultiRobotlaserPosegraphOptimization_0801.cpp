...
public:
    ...
    //     std::cout << "tree_build:" << !friend_robot->scManager.is_tree_batch_made << std::endl;
    ...
    //         std::cout << "Tree constructed for friend_robot_id: " << friend_robot->robot_id 
    //           << " with " << friend_robot->scManager.polarcontext_invkeys_to_search_.size() << " entries." << std::endl;
