...
public:
    ...
    pcl::PointCloud<QuatroPointType> src_matched_pcl;
    pcl::PointCloud<QuatroPointType> tgt_matched_pcl;
    ...
    void setFeaturePair(pcl::PointCloud<QuatroPointType>::Ptr src, pcl::PointCloud<QuatroPointType>::Ptr target){
        ...
        // std::cout << setprecision(4) << " " << sec.count() << " sec. ";
    ...
    pcl::PointCloud<QuatroPointType> getSrcKps(){
        return src_matched_pcl;
    }
    pcl::PointCloud<QuatroPointType> getTgtKps(){
...
//        std::string txtname = (boost::format("%s/%06d_to_%06d.txt") % savedir_ % src_idx %tgt_idx).str();
         ...
         * Source is the first!!!
         */
        pcl::PointCloud<QuatroPointType> merge = src_matched_pcl + tgt_matched_pcl;
...
//        num_check.close();
    ...
    void loadFeaturePair(int src_idx, int tgt_idx, bool verbose=false){
        ...
        pcl::PointCloud<QuatroPointType> merge;
